...
const features = [
  {
    ...
    description:
      "Get started with professionally written, well-structured code that scales.",
  },
  {
    icon: <RocketLaunchIcon className="w-6 h-6" />,
    title: "Quick Deployment",
    description:
      "Deploy your application with one click to your favorite cloud platform.",
  },
  {
    icon: <CpuChipIcon className="w-6 h-6" />,
    title: "AI Integration",
    description:
      "Built-in AI capabilities to supercharge your application features.",
  },
];
...
const pricingPlans = [
  {
    ...
    priceId: "price_1MhvW6JKXVyEzudzYGzafovE",
  },
  {
    title: "Pro",
    price: "249",
...
const faqs = [
  {
    ...
    answer:
      "The starter package includes all essential features to get your project up and running, including basic analytics, community support, and API access.",
  },
  {
    question: "Can I upgrade my plan later?",
    answer:
      "Yes, you can upgrade your plan at any time. Your new features will be available immediately after upgrading.",
  },
  {
    question: "Do you offer custom development?",
    answer:
      "Yes, our enterprise plan includes custom development options to meet your specific needs.",
  },
];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              Have questions about our product? Need help getting started? We're
              here to help.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#111111] rounded-xl p-6 border border-white/5">
              ...
              <p className="text-white/80 mb-6">
                This toolkit saved us months of development time. We launched
                our MVP in just 2 weeks!
              </p>
            ...
            <div className="bg-[#111111] rounded-xl p-6 border border-white/5">
              ...
              <p className="text-white/80 mb-6">
                The code quality is exceptional. It's like having a senior
            ...
            <div className="bg-[#111111] rounded-xl p-6 border border-white/5">
              ...
              <p className="text-white/80 mb-6">
                Best investment we made for our startup. The support is amazing
                too!
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center bg-white/5 px-4 py-2 rounded-full">
              ...
              <div className="text-white/60 text-sm">
                Join <span className="text-white font-medium">5,000+</span>{" "}
                makers
              </div>
            </div>
          </div>
